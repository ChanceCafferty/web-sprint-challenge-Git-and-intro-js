...
// Hint - Look up the .split() method
  ...
  function get20s(array){
   ...
   for(let i = 0; i < array.length; i++){
     ...
     if(artistYears[0] > '1900' && artistYears[2] < '2000'){
...
function addArtist(array) {
  array.push({
    'id': 20,
    'name': 'Chance Cafferty',
    'years': '1994 - 1/14/2021',
    'genre': 'Web Design',
    'nationality': 'American',
    'bio': 'This sprint is making me want to cry. I will make it though.'
